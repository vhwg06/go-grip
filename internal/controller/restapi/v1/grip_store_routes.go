...
func (r *V1) registerGripStoreRoutes(apiV1Group fiber.Router) {
	...
	adminGroup.Get("/orders/:id/refund-status", r.gripAdminGetOrderRefundStatus)
	...
	adminGroup.Get("/refunds/:id", r.gripAdminGetRefund)
	...
	adminGroup.Put("/store-settings/presence", r.gripAdminPutStoreSettingsPresence)
