...
func ModuleToCategory(e catalogmodule.Category) Category {
	return Category{
		ID:        e.ID,
		Name:      e.Name,
		ParentID:  e.ParentID,
...
func ModuleToSetting(e catalogmodule.Setting) Setting {
	return Setting{
		Key:       e.Key,
		Value:     e.Value,
		UpdatedAt: e.UpdatedAt,
...
func DetailToModule(m ProductDetail) catalogmodule.ProductSpecItem {
	return catalogmodule.ProductSpecItem{
		Key:   m.Key,
		Value: m.Value,
	}
}

func ModuleToDetail(productID string, e catalogmodule.ProductSpecItem) ProductDetail {
...
func AdminMessageToModule(m AdminMessage) notificationmodule.AdminMessage {
	return notificationmodule.AdminMessage{
		ID:          m.ID,
...
func ModuleToAdminMessage(e notificationmodule.AdminMessage) AdminMessage {
	return AdminMessage{
		ID:          e.ID,
