...
- [ ] T096 [US5] Implement notification usecase for unified inbox, unread count, mark read, mark all read, clear inbox, and translation-key payloads in internal/usecase/notification/notification.go
